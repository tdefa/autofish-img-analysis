...
if __name__ == '__main__':
    ...
    # %% Folder to save, image dimensions
    # path_parent = Path(r'D:\Documents\data-rna-imaging\gariboldi_t-cell-fate\2023-01-12_Tcells-18genes_F51\images_multi-stack')
    # path_data = Path(r'/media/tom/T7/2023-09-06_LUSTRA-14rounds/images_raw/')
    ...
    for path_images in tqdm(path_list):
        ...
        try:
            ...
            # >> Create path to save images
            path_save = str(path_images)
            for old, new in string_replacements_path:
                path_save = re.sub(old, new, path_save, count=0, flags=0)
